...
def grid_radar(radar, domain, weight=None, fields=None, gatefilter=None,
               ...
               gqi_field=None, debug=False, verbose=False, gridding_fields=True, #):
    ...
    #--- advection added by oue 2017.05.11  
    #u_adv=UnivariateSpline(alt_sonde, u_sonde).__call__(z_g)
    #v_adv=UnivariateSpline(alt_sonde, v_sonde).__call__(z_g)
